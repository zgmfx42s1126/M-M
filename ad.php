   ...
   <div class="container">
      ...
      <section>
         ...
         <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
            ...
            <input type="submit" value="add the product" name="add_product" class="btn1">
         </form>
                  ...
                  while ($row = mysqli_fetch_assoc($select_products)) {
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="index.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i>
                              update </a>
                        </td>
                     </tr>
